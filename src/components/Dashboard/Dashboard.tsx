...
/**
 * Generates a deterministic CSS gradient based on the project title.
...
function Dashboard({ onOpenProject, onCreateNew }: DashboardProps) {
    const { user } = useAuth();
        ...
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-2">Welcome to CodeSplit</h1>
                    <p className="text-slate-400 mb-6">Sign in to save and manage your projects</p>
                </div>
            </div>
        );
    }
                ...
                {projects.length === 0 && !error && (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <div className="relative mb-8">
                            ...
                            <div className="absolute -bottom-1 -left-3 w-3 h-3 bg-blue-500 rounded-full animate-pulse delay-150" />
                            <div className="absolute top-1/2 -right-4 w-2 h-2 bg-cyan-400 rounded-full animate-pulse delay-300" />
                        </div>

                        {/* Text */}
                        <h2 className="text-2xl font-bold text-white mb-3">No projects yet. Start coding!</h2>
                        <p className="text-slate-400 mb-8 max-w-md text-center">
                            Create your first project and bring your ideas to life with HTML, CSS, and JavaScript.
                        </p>
                        ...
                        <p className="text-slate-600 text-sm mt-6">
                            Your projects are saved automatically to the cloud
                        </p>
                    </div>
                )}
